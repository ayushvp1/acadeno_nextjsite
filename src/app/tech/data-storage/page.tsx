...
import { Database, LineChart, ShieldCheck, DatabaseZap, Search, Zap } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 z-10">
            ...
            <p className="text-on-surface font-body font-[600] leading-relaxed text-lg md:text-xl mb-10 text-justify">
              We build high-performance data architectures that handle millions of transactions with sub-second latency and absolute reliability.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">Distributed Databases</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                Architectures for massive scale and redundancy using SQL, NoSQL, and vector-based storage solutions.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">Real-time Analytics</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                Stream processing for instant data-driven insights and business intelligence at the speed of thought.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">Data Sovereignty</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                Secure storage solutions that meet global compliance standards including GDPR, HIPAA, and local laws.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-12">
              <div className="flex gap-8">
                ...
                <div>
                  <h3 className="text-xl font-[900] text-on-surface mb-3">High-Frequency I/O</h3>
                  <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                    Optimized caching and storage engine configurations for extreme transaction throughput.
                  </p>
                </div>
              </div>
              <div className="flex gap-8">
                ...
                <div>
                  <h3 className="text-xl font-[900] text-on-surface mb-3">Intelligent Search</h3>
                  <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                    Implementation of vector search and semantic indexing for sophisticated data retrieval systems.
                  </p>
                </div>
              </div>
            </div>
