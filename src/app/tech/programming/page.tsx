...
import { Code2, Layers, Cpu, Globe, Rocket, Zap } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 z-10">
            ...
            <p className="text-on-surface font-body font-[600] leading-relaxed text-lg md:text-xl mb-10 text-justify">
              We leverage the most efficient languages and frameworks to build scalable, maintainable, and extremely fast enterprise software.
            </p>
          ...
          <div className="lg:col-span-5 relative">
            <div className="rounded-[40px] overflow-hidden shadow-2xl relative aspect-[4/3]">
              <Image 
                src="/assets/tech_programming_hero.png" 
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">Python & Rust</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                High-performance backend systems, AI logic, and memory-safe infrastructure components.
              </p>
            </div>
            {/* Feature 2 */}
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">React & Next.js</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                State-of-the-art frontend experiences with lightning-fast performance and SEO-first architecture.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="p-10 rounded-[32px] bg-[#f8f9fd] border border-slate-100 hover:shadow-xl transition-all group active:scale-[0.98]">
              ...
              <h3 className="text-2xl font-[900] text-on-surface mb-4">Microservices</h3>
              <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                Modular, scalable architectures built with Go, Node.js, and Java for distributed enterprise environments.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-12">
              <div className="flex gap-8">
                ...
                <div>
                  <h3 className="text-xl font-[900] text-on-surface mb-3">API-First Design</h3>
                  <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                    Robust, well-documented RESTful and GraphQL APIs for seamless multi-platform consumption.
                  </p>
                </div>
              </div>
              <div className="flex gap-8">
                ...
                <div>
                  <h3 className="text-xl font-[900] text-on-surface mb-3">Serverless Functions</h3>
                  <p className="text-lg font-[600] text-on-surface-variant leading-relaxed">
                    Highly scalable, event-driven logic that minimizes infrastructure overhead and maximizes speed.
                  </p>
                </div>
              </div>
            </div>
