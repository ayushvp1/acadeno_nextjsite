...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        id="main-nav"
        className={`fixed top-0 w-full z-[1000] backdrop-blur-md transition-all duration-300 h-[64px] sm:h-[72px] md:h-[80px] ${isScrolled
        ...
        <div className="flex justify-between items-center w-full px-4 sm:px-6 md:px-10 max-w-[1700px] mx-auto h-full">
          ...
          <div className="lg:hidden flex items-center gap-2 h-full relative z-[10001]">
            <button
              ...
              className={`w-12 h-12 flex flex-col justify-center items-center gap-[6px] focus:outline-none rounded-xl active:scale-95 transition-all duration-150 shadow-md border cursor-pointer touch-manipulation ${isScrolled
