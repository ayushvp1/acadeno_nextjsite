...
export default function VisionMission() {
  return (
    <section id="vision-mission" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 relative bg-white">
      <div className="max-w-4xl mx-auto text-center space-y-10 sm:space-y-16">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <h3 className="font-headline text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight text-[#1e293b]">
            Our Vision
          </h3>
          <p className="text-base sm:text-lg md:text-xl font-bold text-slate-600 leading-[1.8] max-w-3xl mx-auto text-center">
